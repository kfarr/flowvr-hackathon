...
// Very similar to https://gist.github.com/mrflix/8351020
    ...
    MouseKeyboardPositionSensorVRDevice.prototype.resetCamera = function() {
        this.phi = 0;
        this.theta = 0
    }
...
WebVRPolyfill.prototype.enablePolyfill = function() {
  ...
  if (this.isMobile()) {
    ...
    if (!WebVRConfig.MOUSE_KEYBOARD_CONTROLS_DISABLED) {
        window.mouseKeyboardPositionSensorVRDevice = new MouseKeyboardPositionSensorVRDevice();
        this.devices.push(window.mouseKeyboardPositionSensorVRDevice);
    }
    // Uncomment to add positional tracking via webcam.
