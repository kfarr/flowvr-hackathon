...
var DEFAULT_IOS = new Device({
  ...
  bevelMeters: 0.004
    ...
    var DEFAULT_DESKTOP = new Device({
        widthMeters: 0.0,
        heightMeters: 0.0,
        bevelMeters: 0.0
    })
...
DeviceInfo.prototype.determineDevice_ = function(deviceParams) {
  if (!deviceParams) {
    ...
    if (Util.isIOS()) {
      console.warn("Using fallback iOS device measurements."); //JM fixed
      return DEFAULT_IOS;
    } else if (Util.isAndroid()) {
      console.warn("Using fallback Android device measurements."); //JM fixed
      return DEFAULT_ANDROID;
    } else {
        console.warn("Using Desktop device measurements."); //JM fixed
...
Util.isAndroid = function() { //added by JM
